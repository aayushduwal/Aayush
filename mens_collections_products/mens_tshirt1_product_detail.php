...
<body>
  ...
  <div class="product-container">
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="https://img.drz.lazcdn.com/static/np/p/e8dba39b7552c4e1829daafd0ccab7cc.jpg_960x960q80.jpg_.webp"
          ...
          <div class="small-img-row">
            ...
            <div class="small-img-col">
              <img
                src="https://crooveclo.com/cdn/shop/files/jpg_ce15f9ab-2631-4db8-9ed9-7ab2ffd9af77.jpg?v=1720866485&width=1024"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6dqW2NVxqad4mGOKlOXF5zs36pkonuLwgua1FaYFW95Sq_pw0vGLwHGOr69InFW46Gp0&usqp=CAU"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
          </div>
        </div>
        <div class="col-2">
          <p>Home / T-shirt</p>
          <h1>Cotton Plain Half Sleeves T-Shirt</h1>
          <h4>$50.00</h4>
          <select>
