...
// Fetch all sweatshirts
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Men' AND subcategory = 'Sweatshirts'");
$stmt->execute();
$sweatshirts = $stmt->get_result();
?>
...
<head>
    ...
    <title>Men's Sweatshirts - Elegance</title>
...
<body>
    ...
    <div class="category-header">
        <h1>Men's Sweatshirts</h1>
        <div class="breadcrumb">
            <a href="../../index.php">Home</a> / 
            <a href="../index.php">Men's Collection</a> / 
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $sweatshirts->fetch_assoc()): ?>
