...
// Fetch all jackets
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Men' AND subcategory = 'Jackets'");
$stmt->execute();
$jackets = $stmt->get_result();
?>
...
<head>
    ...
    <title>Men's Jackets - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $jackets->fetch_assoc()): ?>
