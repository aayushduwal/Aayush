...
// Fetch all hoodies
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Men' AND subcategory = 'Hoodies'");
$stmt->execute();
$hoodies = $stmt->get_result();
?>
...
<head>
    ...
    <title>Men's Hoodies - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $hoodies->fetch_assoc()): ?>
