        ...
        <div class="row">
          <div class="col-2">
            ...
            <div class="small-img-row">
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/71kA-er1oZL._AC_SX466_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/61zDk4QsWRL._AC_SX466_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
          ...
          <div class="col-2">
            <p>Home / Jacket</p>
            <h1>NIKE Sportswear Men's Pullover Club Hoodie</h1>
            <h4>$50.00</h4>
            <select>
