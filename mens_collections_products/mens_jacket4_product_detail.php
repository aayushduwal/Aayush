  ...
  <head>
    ...
    <style>
      * {
      ...
      .product-container {
        margin-top: 560px; /* Adjust this value to match the height of your navbar */
      }
      .small-container {
        margin-top: 200px;
        max-width: 1200px;
        ...
        <div class="row">
          <div class="col-2">
            ...
            <div class="small-img-row">
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/61gRD5jatLL._AC_SX569_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/51ZRqayvSnL._AC_SX569_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
