  ...
  <head>
    ...
    <style>
      * {
      ...
      .product-container {
        margin-top: 650px; /* Adjust this value to match the height of your navbar */
      }
      .small-container {
        margin-top: 200px;
        max-width: 1200px;
    ...
    <div class="product-container">
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img
              src="https://m.media-amazon.com/images/I/81s9x-g6EEL._AC_SY550_.jpg"
              width="100%"
              id="ProductImg"
            ...
            <div class="small-img-row">
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/81IyJ8EUi-L._AC_SY550_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/91WljSuhzIL._AC_SY550_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
