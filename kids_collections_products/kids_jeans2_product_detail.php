  ...
  <div class="product-container">
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          ...
          <div class="small-img-row">
            <div class="small-img-col">
              <img
                src="https://img.drz.lazcdn.com/static/np/p/0feddb4e40a8cea23742e1e723102bd9.jpg_720x720q80.jpg_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img
                src="https://img.drz.lazcdn.com/static/np/p/211c35da41baae8dc0bd7c231873cb57.jpg_720x720q80.jpg_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
          </div>
        </div>
        <div class="col-2">
          <p>Home / Jacket</p>
          <h1>Jeans Rocky Pant For Kids</h1>
          <h4>$50.00</h4>
          <select>
