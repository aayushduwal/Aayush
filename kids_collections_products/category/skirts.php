...
// Fetch all skirts
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Kids' AND subcategory = 'Skirts'");
$stmt->execute();
$skirts = $stmt->get_result();
?>
...
<head>
    ...
    <title>Kids' Skirts - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $skirts->fetch_assoc()): ?>
