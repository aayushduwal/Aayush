...
// Fetch all winterwear
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Kids' AND subcategory = 'Winterwear'");
$stmt->execute();
$winterwear = $stmt->get_result();
?>
...
<head>
    ...
    <title>Kids' Winterwear - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $winterwear->fetch_assoc()): ?>
