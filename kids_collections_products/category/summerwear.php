...
// Fetch all summerwear
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Kids' AND subcategory = 'Summerwear'");
$stmt->execute();
$summerwear = $stmt->get_result();
?>
...
<head>
    ...
    <title>Kids' Summerwear - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $summerwear->fetch_assoc()): ?>
