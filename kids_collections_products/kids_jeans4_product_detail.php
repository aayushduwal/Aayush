    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          ...
          <div class="small-img-row">
            <div class="small-img-col">
              <img
                src="https://img.drz.lazcdn.com/static/np/p/3229d31a018ac9b8c45d02d5a4c72c61.png_720x720q80.png_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img
                src="https://img.drz.lazcdn.com/static/np/p/2035c117dfa435b9151043282f723087.png_720x720q80.png_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
          </div>
        </div>
        <div class="col-2">
          <p>Home / Jacket</p>
          <h1>
            Kid Boy Mildly Distressed Knee Length Denim Jeans Shorts - Blue
          </h1>
          <h4>$50.00</h4>
          <select>
