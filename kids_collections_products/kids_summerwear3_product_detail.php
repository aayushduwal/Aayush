      ...
      <div class="row">
        <div class="col-2">
          ...
          <div class="small-img-row">
            ...
            <div class="small-img-col">
              <img src="https://img.drz.lazcdn.com/g/kf/Sd42d0f69ebbf41289c466e5f786060ecp.jpg_720x720q80.jpg_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img src="https://img.drz.lazcdn.com/g/kf/Sa9cb360bbe314d7d800be7dd43ec0794M.jpg_720x720q80.jpg_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img src="https://img.drz.lazcdn.com/g/kf/Seba795b464b64313b4ec7b8a817d74a8x.jpg_720x720q80.jpg_.webp"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
          </div>
        </div>
        <div class="col-2">
          <p>Home / Jacket</p>
          <h1>
            Clothing Set Children's Top and Bottom Clothes set Two Pieces
            Summer Outfit for Kids Boys Girls
          </h1>
          <h4>NRP-2500</h4>
          <select>
          ...
          <br />
          <p>
            This Clothing Set Children's Top and Bottom Clothes set Two Pieces
            Summer Outfit for Kids Boys Girls is made from 100% cotton, it
            offers a slim fit that provides comfort and breathability, making
            it perfect for warm weather. Available in multiple sizes.
          </p>
        </div>
      </div>
    </div>
