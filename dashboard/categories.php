...
<div class="main-content">
    ...
    <div class="filter-section">
        <form method="GET" class="filter-form">
            <input type="text" name="search" placeholder="Search products..." value="<?php echo htmlspecialchars($search); ?>" class="form-control" style="display: inline-block; width: 500px; height: 40px; font-size: 16px;">
        ...
        <tbody>
            <?php while ($product = $products->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <img src="../uploads/products/<?php echo htmlspecialchars($product['images']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" class="product-thumbnail">
                    </td>
