    ...
    <div class="contact-info">
      ...
      <div class="second-info info">
        ...
        <ul>
          ...
          <li><a href="/aayush/shipping-returns.php">
              <p>Shopping & Returns</p>
            </a></li>
          <li><a href="/aayush/privacy.php">
              <p>Privacy</p>
            </a></li>
        </ul>
      </div>
      ...
      <div class="third-info info">
        <h4>Shop</h4>
        <ul>
          <li><a href="/aayush/mens_collections_products/index.php">
              <p>Men's Shopping</p>
            </a></li>
          <li><a href="/aayush/womens_collections_products/index.php.">
              <p>Women's Shopping</p>
            </a></li>
          <li><a href="/aayush/kids_collections_products/index.php">
              <p>Kid's Shopping</p>
            </a></li>
