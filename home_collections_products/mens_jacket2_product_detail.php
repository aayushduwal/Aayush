...
<body>
  ...
  <div class="product-container">
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="../images/index-page_images/mens_collection/jacket1.png"
          ...
          <div class="small-img-row">
            ...
            <div class="small-img-col">
              <img
                src="https://blink182merch.com/cdn/shop/files/Blink_0015_REVISED_JACKET_ER-B.png?v=1722300115&width=1000"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
            <div class="small-img-col">
              <img
                src="https://down-id.img.susercontent.com/file/id-11134207-7r98u-ly91zb23aeaj68"
                width="100%" class="small-img" alt="Cotton Plain Half Sleeves T-Shirt" />
            </div>
          </div>
        </div>
        <div class="col-2">
          <p>Home / Jacket</p>
          <h1>Blink 182 Jacket Adult S Black Graphic Road Crew Band Mens</h1>
          <h4>$50.00</h4>
          <select>
