...
// Fetch all shirts
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Women' AND subcategory = 'Bottoms'");
$stmt->execute();
...
<head>
    ...
    <title>Women's Bottoms - Elegance</title>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $bottoms->fetch_assoc()): ?>
