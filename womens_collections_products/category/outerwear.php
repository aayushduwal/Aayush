...
// Fetch all shirts
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Women' AND subcategory = 'Outerwear'");
$stmt->execute();
$outerwear = $stmt->get_result();
?>
...
<head>
    ...
    <title>Women's Outerwear - Elegance</title>
...
<body>
    ...
    <div class="category-header">
        ...
        <div class="breadcrumb">      
            ...
            <a href="../index.php">Women's Collection</a> / 
            <span>Outerwear</span>
        </div>
    </div>
    ...
    <section class="collection">
        <div class="container">
            <div class="collection-wrapper">
                <?php while($product = $outerwear->fetch_assoc()): ?>
