        ...
        <div class="row">
          <div class="col-2">
            ...
            <div class="small-img-row">
              ...
              <div class="small-img-col">
                <img
                  src="https://img.drz.lazcdn.com/static/np/p/689377b0071df955b59c7011b6cd3cee.png_720x720q80.png_.webp"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://img.drz.lazcdn.com/static/np/p/36b5098f4d9511ff679c56e86f9bfaa0.png_720x720q80.png_.webp"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
          ...
          <div class="col-2">
            <p>Home / Jacket</p>
            <h1>
              Blue Granch Non Stretch Plain Parallel Jeans For Women - Fashion |
              Jeans | Pants For Women | Women's Wear
            </h1>
            <h4>$50.00</h4>
            <select>
