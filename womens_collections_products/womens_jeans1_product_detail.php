  ...
  <head>
    ...
    <style>
      * {
      ...
      .product-container {
        margin-top: 550px; /* Adjust this value to match the height of your navbar */
      }
      .small-container {
        margin-top: 200px;
        max-width: 1200px;
        ...
        <div class="row">
          <div class="col-2">
            ...
            <div class="small-img-row">
              ...
              <div class="small-img-col">
                <img
                  src="https://m.media-amazon.com/images/I/71KItw272KL._AC_UY1000_.jpg"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGJykY6XwsV2RMZGNvKzwi7R7sHbi9koPZC2rnuml8RRdroMr728Ss2_Ycb6EpjrhfAYs&usqp=CAU"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
              ...
              <div class="small-img-col">
                <img
                  src="https://rukminim2.flixcart.com/image/850/1000/xif0q/jean/w/u/f/30-staright-fit-jeans-light-blue-30new-mikuchiku-original-imahfca5yjj7pawj.jpeg?q=20&crop=false"
                  width="100%"
                  class="small-img"
                  alt="Cotton Plain Half Sleeves T-Shirt"
                />
          ...
          <div class="col-2">
            <p>Home / Jacket</p>
            <h1>Oversize Straight Light Blue Jeans For Women</h1>
            <h4>$50.00</h4>
            <select>
